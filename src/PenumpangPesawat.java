...
class  Penumpang {
    ...
    Penumpang next;     // Pointer ke penumpang berikutnya

    // Konstruktor untuk inisialisasi nama penumpang
    Penumpang(String name) {
        this.name = name;
        this.next = null;
    }
}
...
// Kelas Flight
class Flight {
    private  Penumpang head; // Kepala dari linked list penumpang
    ...
    public void addPassenger(String name) {
        Penumpang newPassenger = new  Penumpang(name); // Membuat penumpang baru
    ...
    public void displayPassengers() {
        Penumpang current = head; // Memulai dari kepala
        while (current != null) {
